        ...
        <div class="bg-white p-10 shadow-sm">
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <div class="px-5 pt-0 text-left pb-5" v-show="accordionIndex == 0">
              <p class="leading-6 font-light pl-9 ">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi dolor dolorum odio, saepe quibusdam iusto
                possimus nesciunt dolores assumenda quae totam, doloremque odit. Itaque cum animi, labore debitis deserunt
                iusto!
              </p>
            </div>
          </div>
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordionIndex == 1">
              <p class="leading-6 font-light pl-9 ">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut suscipit itaque, sequi incidunt ab sit optio
                debitis dignissimos doloribus ratione nobis id mollitia maiores eveniet necessitatibus dolorum
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordionIndex == 3">
              <p class="leading-6 font-light pl-9">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam minima maiores magni dolore qui architecto
                pariatur incidunt repellat quos hic? Eius, eveniet accusantium! Quisquam, quo. Vitae ipsum ad veritatis
                commodi quasi expedita!
              </p>
            </div>
        </div>
      </div>
